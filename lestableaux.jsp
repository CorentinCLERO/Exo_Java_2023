...
réponse : <br/>
<%
out.print(Integer.parseInt(tableauDeChiffres[0]) * Integer.parseInt(tableauDeChiffres[0]));
%>
</p>
...
réponse : <br/>
<%
out.print(Integer.parseInt(tableauDeChiffres[0]) + Integer.parseInt(tableauDeChiffres[1]) + Integer.parseInt(tableauDeChiffres[2]));
%>
</p>
